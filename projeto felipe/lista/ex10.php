...
<div style="grid-area: cabecalho;
    ...
    justify-self: center;
    align-items: center;
    padding: 16px;"><h3>Exercicio 10</h3>
<h5>Criar uma calculadora de 4 número, 
    sendo a operação escolhida pelo usuário (adição, subtração, multiplicação e divisão).</h5></div>
    <br>
    <br>
    <h5>Resposta:</h5>
    </head>
